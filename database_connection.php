...
DEFINE('DATABASE_USER', 'a3702hos_symp');
DEFINE('DATABASE_PASSWORD', 'symposium');
DEFINE('DATABASE_HOST', 'localhost');
DEFINE('DATABASE_NAME', 'a3702hos_sympo');
