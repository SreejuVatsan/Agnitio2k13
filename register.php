...
if (empty($_POST['college'])) {
    ...
    { // If everything's OK...
        ...
        if (mysqli_num_rows($result_verify_email) == 0) { // IF no previous user is using this email .
            ...
            $query_insert_user = "INSERT INTO `table_name` ( `id`,`name`, `Email`, `mobile`,`dept`,`college`,`events`) VALUES ('','$name', '$Email', '$mobile','$dept','$college','$events')";
            ...
            if (mysqli_affected_rows($dbc) == 1) { //If the Insert Query was successfull.
                ...
                // Send the email
                $message = "Greeting from team AGNITIO!!!\n\n Registration successfull:\n\nName: $name\nEmail: $Email\nDepartment: $dept\nThank You for registering.\n\nFor updates please visit www.facebook.com/agnitio.prozilos\n";
                mail($Email, 'Registration details', $message, 'From: prozilos.com');
...
has been sent to '.$Email.' Please check your registration details </div>';
